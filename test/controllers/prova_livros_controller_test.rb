...
class ProvaLivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prova_livro" do
    assert_difference('ProvaLivro.count') do
      post prova_livros_url, params: { prova_livro: { curso_id: @prova_livro.curso_id, disciplina_id: @prova_livro.disciplina_id, nota: @prova_livro.nota } }
    end
  ...
  test "should update prova_livro" do
    patch prova_livro_url(@prova_livro), params: { prova_livro: { curso_id: @prova_livro.curso_id, disciplina_id: @prova_livro.disciplina_id, nota: @prova_livro.nota } }
