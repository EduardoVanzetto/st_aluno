...
class PresencasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presenca" do
    assert_difference('Presenca.count') do
      post presencas_url, params: { presenca: { curso_id: @presenca.curso_id, disciplina_id: @presenca.disciplina_id, presenca: @presenca.presenca } }
    end
  ...
  test "should update presenca" do
    patch presenca_url(@presenca), params: { presenca: { curso_id: @presenca.curso_id, disciplina_id: @presenca.disciplina_id, presenca: @presenca.presenca } }
