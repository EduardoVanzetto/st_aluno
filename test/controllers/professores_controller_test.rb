...
class ProfessoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professores_url, params: { professor: { endereco_id: @professor.endereco_id, usuario_id: @professor.usuario_id } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { endereco_id: @professor.endereco_id, usuario_id: @professor.usuario_id } }
